# Generated by Django 3.0.3 on 2020-03-13 11:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('buname', models.CharField(max_length=64, unique=True, verbose_name='事业部')),
            ],
        ),
        migrations.CreateModel(
            name='Company',
            fields=[
                ...
                ('companybu', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='collector.BusinessUnit')),
            ],
            options={
